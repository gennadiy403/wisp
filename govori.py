...
4. Предлоги при упоминании проектов/компаний из словаря TERMS:
   - Речь о работе/задачах в проекте → "по Marquiz", "по Travelmart", "в SKVO"
   - Не "к проекту" (к подразумевает физическое движение или обращение к человеку)
   - Выбирай естественный русский предлог по контексту глагола
